...
#define _009F_TAU_TDR00_VALUE               (0x009FU)
/* 16-bit timer data register 02 (TDR02) */
#define _0050_TAU_TDR02_VALUE               (0x0050U)
...
#define _E4E0_TAU_TDR03_VALUE               (0xE4E0U)
/* Clock divisor for TAU0 channel3 */
#define _16384_TAU0_CHANNEL3_DIVISOR            (16384U)
...
/* Clock divisor for TAU0 channel5 */
#define _256_TAU0_CHANNEL5_DIVISOR            (256U)
...
#define _01FD_TAU_TDR10_VALUE               (0x01FDU)
/* 16-bit timer data register 12 (TDR12) */
#define _00FF_TAU_TDR12_VALUE               (0x00FFU)
/* 16-bit timer data register 14 (TDR14) */
#define _00FF_TAU_TDR14_VALUE               (0x00FFU)
/* Clock divisor for TAU1 channel0 */
#define _1_TAU1_CHANNEL0_DIVISOR            (1U)
/* Clock divisor for TAU1 channel0 */
#define _1_TAU1_CHANNEL2_DIVISOR            (1U)
/* Clock divisor for TAU1 channel0 */
#define _1_TAU1_CHANNEL4_DIVISOR            (1U)
/* Clock divisor for TAU1 channel6 */
#define _64_TAU1_CHANNEL6_DIVISOR            (64U)
/* Clock divisor for noise filter */
#define _06_TAU1_NOISE_DIVISOR              (0x06U)
/* Set channels that use noise filter sampling clock */
