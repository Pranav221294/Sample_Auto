...
******************************************************************************/
#ifndef __OilPressureGauge_H
#define __OilPressureGauge_H

// Global prototypes --------------------------------------------------------

/// @addtogroup OIL_PRESSURE_LIBRARY
/// @{
/// @defgroup OilPreeLib  functions used 
//// 
///   
/// @addtogroup OilPreeLib
/// @{

bool bOilPressureSymbolStatus(void);
u8 u8OilPressureBarNo(void);
void vOilPressureGauge(void);
void vSetOilPressureBarNo(u8 BarNo);

/// @} // endgroup OilPreeLib

/// @} // endgroup OIL_PRESSURE_LIBRARY
